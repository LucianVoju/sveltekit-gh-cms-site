...
Skip to content Search or jump to… Pull requests Issues Marketplace Explore @LucianVoju sw-yx /
swyxdotio Public Code Issues 163 Pull requests Actions Projects Wiki Security Insights
swyxdotio/src/components/WebMentions.svelte @sw-yx sw-yx Update WebMentions.svelte Latest commit
26a8747 11 days ago History 2 contributors @sw-yx@eps1lon 360 lines (358 sloc) 9.56 KB
						...
						<div>
							...
							{:else}
								...
								{#if link.data.content}
									<div>
										<p
											class="prose border-l-2 border-teal-500 pl-2 italic dark:prose-invert"
											font-family="system"
											color="tertiary"
											font-size="2"
										>
